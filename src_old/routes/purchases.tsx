          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            {filtered.map((p) => (
              <button
                ...
                className="clay group flex flex-col overflow-hidden p-3 text-left transition-all duration-300 hover:border-primary/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--sky-deep)]"
              >
